...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-[12vh] lg:h-[40vh] flex justify-center items-center 2xl:justify-center px-4 relative z-20 overflow-hidden xl:overflow-hidden">
      ...
      <div className="hidden lg:w-[100%] xl:w-[100%] 2xl:w-[100%] md:flex lg:flex justify-center gap-24 items-center ml-auto text-white font-semibold text-lg z-10 mt-72 lg:mt-68 p-4">
        <button
          onClick={handleHome}
