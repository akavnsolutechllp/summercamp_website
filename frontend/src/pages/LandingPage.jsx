      ...
      <div className="h-auto w-full flex flex-col justify-center items-center p-2">
        ...
        <div className="h-full w-full flex flex-col justify-center items-center gap-3 xl:gap-5 lg:mt-8 xl:mt-0 z-20 ">
          <motion.h1
            ...
            className="font-montserrat uppercase text-[#f79824] drop-shadow-md drop-shadow-[#FF0066] text-stroke p-1 rounded-2xl flex flex-col justify-center items-center text-5xl  tracking-wide mb-3 md:text-[16vw] lg:text-[6vw]  text-center"
          >
          ...
          <motion.p
            ...
            className="font-montserrat text-white text-justify tracking-tight lg:tracking-normal lg:text-center lg:text-base text-base 2xl:text-center 2xl:tracking-tight p-2 lg:mt-8 lg:w-[75%] md:w-[80%] "
          >
