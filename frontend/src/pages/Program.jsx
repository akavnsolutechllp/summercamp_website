...
const handleKnowmore = () =>{
  ...
  return (
    ...
    >
      ...
      <motion.div className="w-full md:w-[60%] lg:w-[80%] xl:w-[84%] 2xl:w-[60%] h-auto flex flex-col justify-start items-center md:grid md:grid-cols-1 lg:grid lg:grid-cols-2 md:gap-8 lg:gap-6 xl:gap-8 gap-6 py-4 z-10">
        <motion.div
          ...
          className="h-auto w-full min-h-[16vh] lg:h-[70vh] xl:h-[60vh] 2xl:h-[40vh] bg-white/5 border-2 border-[#F79824] shadow-lg shadow-[#F79824] flex flex-col justify-around items-center rounded-2xl gap-3 p-4 md:p-4 relative overflow-hidden"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          whileHover={{scale:1.02}}
          className="h-auto w-full min-h-[16vh] lg:h-[70vh] xl:h-[60vh] 2xl:h-[40vh] bg-white/5 border-2 border-[#E31DB0] shadow-lg shadow-[#E31DB0] flex flex-col justify-around items-center rounded-2xl gap-3 p-4 md:p-4 relative overflow-hidden"
        >
          <h1 className="font-montserrat text-center text-2xl md:text-6xl lg:text-4xl xl:text-3xl 2xl:text-3xl text-white w-full z-20">
            Inventor’s Workshop
          </h1>
          <div className="h-[40%] w-full flex justify-center items-center z-20">
            <img src={inventor} alt="" className='w-[80%] lg:w-[63%] xl:w-[52%] 2xl:w-[40%]' />
          </div>
        ...
        >
          ...
          <div className="h-[40%] w-full flex justify-center items-center z-20">
            <img src={circuit} alt="" className='w-[80%] lg:w-[66%] xl:w-[56%] 2xl:w-[60%]' />
          </div>
