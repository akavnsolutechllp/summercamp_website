...
const Registration = () => {
  ...
  return (
    <div id='Registration' className='bg-gradient-to-b from-[#283353] via-[#283353] to-[#16003E] min-h-screen h-auto w-full flex flex-col justify-center items-center  overflow-hidden'>
      <Navbar/>
      <Menu/>
      <div className='min-h-screen w-full flex flex-col justify-center items-center gap-4 p-4'>
        <h2 className='text-white text-4xl 2xl:text-6xl font-gardion'>Register Now</h2>
      <form
  ...
  {/* Grade */}
  <div className='w-full 2xl:w-[50%] flex flex-col justify-center items-start mr-8'>
  ...
  {/* Age */}
  <div className='w-full 2xl:w-[25%] flex flex-col justify-center items-start'>
  ...
  {/* Gender */}
  <div className='w-full 2xl:w-[25%] flex flex-col justify-center items-start'>
    <label className='font-montserrat text-lg text-black'>Gender</label>
