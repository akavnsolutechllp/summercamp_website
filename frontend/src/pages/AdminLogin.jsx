  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://summercamp-website.onrender.com/api/admin/login",
        { email, password },
      );
  ...
  return (
    <div className="bg-[#16003E] min-h-screen h-auto w-full flex flex-col justify-center items-center relative overflow-hidden">
      <img
        src={logo}
        alt=""
        className=" absolute  bg-white rounded-full z-10 opacity-20"
      />
      ...
      <form
        ...
        className="bg-white p-2 w-[90%] lg:w-[50%] xl:w-[30%] 2xl:w-[20%] rounded-lg z-20"
      >
        <input
          type="email"
          placeholder="Email"
        ...
        <button
          type="submit"
          className="w-full bg-[#f79824] text-white p-2 rounded font-montserrat"
        >
          Login
        </button>
      </form>
