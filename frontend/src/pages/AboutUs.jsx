...
const About = () => {
  ...
  return (
    <div id='about' className='min-h-screen h-auto w-full bg-[#283353] flex flex-col md:flex-col lg:flex-row justify-center items-center gap-8 lg:gap-12 py-10 px-4 lg:mt-0 relative mb-0'>
      ...
      <h2 className='font-gardion w-full 2xl:w-auto text-center lg:text-start text-6xl md:text-7xl lg:text-9xl xl:text-7xl 2xl:text-9xl text-[#EE5073] text-stroke drop-shadow-md drop-shadow-[#E31DB0]'>About Us</h2>
