...
const About = () => {
  ...
  return (
    <div className='h-screen w-full bg-[#2E8B57] flex flex-col justify-center items-center gap-8 py-10 px-4'>
      <h1 className='text-[12vw] md:text-[8vw] xl:text-[6vw] 2xl:text-[2.5vw] font-switzal text-[#5D4037] border-4 border-[#5D4037] shadow-lg bg-[#F5F5DC] px-4'>
        About Us
      </h1>

      <motion.div
        style={{ opacity: firstBoxOpacity, y: firstBoxY, scale:firstBoxScale }}
        className='h-[30vh] w-[96%] md:w-[70%] 2xl:w-[50%] md:text-2xl 2xl:text-2xl bg-[#F5F5DC] border-4 border-[#5D4037] text-[#5D4037] flex justify-center items-center p-4 font-montserrat text-justify tracking-tight rounded-xl shadow-md'
      >
      ...
      <motion.div
        ...
        className='h-[40vh] w-[96%] 2xl:w-[50%] md:text-2xl 2xl:text-2xl bg-[#F5F5DC] border-4 border-[#5D4037] text-[#5D4037] flex justify-center items-center p-4 font-montserrat text-justify tracking-tight rounded-xl shadow-md'
      >
