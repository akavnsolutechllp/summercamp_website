    ...
    <div id='liability' className='h-full w-full flex flex-col justify-center items-center bg-gradient-to-b from-[#283253] via-[#283253] to-[#16003E] relative'>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='w-full md:w-[70%] lg:w-[50%] 2xl:w-[40%] flex flex-col justify-center items-center bg-white drop-shadow-lg rounded-xl p-4 '>
        ...
        <div className='w-full h-auto flex flex-col justify-start items-start gap-3 mt-4'>
            ...
            <p className='text-justify'>I understand that participation in Spark STEM Academy’s Summer STEM Camps involves hands-on science, technology, engineering, and outdoor activities that may involve certain risks, including, but not limited to, physical activity, use of lab materials/tools, and interaction with natural elements.</p>
            <p className='text-justify'>I voluntarily assume all risks related to my child’s participation and agree that Spark STEM Academy, its staff, and volunteers will not be held liable for any injury, illness, or loss that may occur during the camp.</p>
        </div>
        <div className='w-full h-auto flex flex-col justify-start items-start gap-3 mt-4'>
            <h1 className='font-montserrat font-bold '>2. Medical Release</h1>
            <p className='text-justify'>In the event of a medical emergency, I authorize the camp staff to obtain necessary medical treatment for my child. I understand that every effort will be made to contact me before taking this action.</p>
        </div>
        ...
        <div className='w-full h-auto flex flex-col justify-start items-start gap-3 mt-4'>
            <h1 className='font-montserrat font-bold '>3. COVID-19 Acknowledgment</h1>
            <p className='text-justify'>I understand that Spark STEM Academy follows recommended health guidelines, but there remains a risk of exposure to COVID-19 and other contagious illnesses. I agree not to hold Spark STEM Academy or its representatives liable in the event of exposure or illness.</p>
        </div>
        ...
        <div className='w-full h-auto flex flex-col justify-start items-start gap-3 mt-4'>
          ...
          <div className='flex items-start gap-2'>
            ...
            <label>I <span className='font-bold'>DO</span>  give permission for Spark STEM Academy to use photographs/videos of my child for educational or promotional purposes (brochures, social media, website).  </label>
          </div>
