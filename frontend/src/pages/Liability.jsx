...
const Liability = () => {
  ...
  return (
    <div id='liability' className='h-full w-full flex flex-col justify-center items-center bg-gradient-to-b from-[#283253] via-[#283253] to-[#16003E] relative'>
      ...
      <div className='min-h-screen w-full flex flex-col justify-center items-center p-4'>
        <form onSubmit={handleSubmit(onSubmit)} className='w-full md:w-[70%] lg:w-[50%] 2xl:w-[40%] flex flex-col justify-center items-center bg-white drop-shadow-lg rounded-xl p-4'>
          ...
          <div className='w-full h-auto flex flex-col justify-center items-start gap-2 my-2' >
              <h1 className='font-bold font-montserrat'>1. Acknowledgment of Risk</h1>
              <p>I understand that participation in Spark STEM Academy’s Summer STEM Camps involves hands-on science, technology, engineering, and outdoor activities that may involve certain risks, including, but not limited to, physical activity, use of lab materials/tools, and interaction with natural elements.</p>
                <p>I voluntarily assume all risks related to my child’s participation and agree that Spark STEM Academy, its staff, and volunteers will not be held liable for any injury, illness, or loss that may occur during the camp.
                </p>
          </div>
          <div className='w-full h-auto flex flex-col justify-center items-start gap-2 my-2' >
              <h1 className='font-bold font-montserrat'>2. Medical Release</h1>
              <p>In the event of a medical emergency, I authorize the camp staff to obtain necessary medical treatment for my child. I understand that every effort will be made to contact me before taking this action.
              </p>
          </div>
          ...
          <div className='w-full mt-4'>
            ...
            <input
              type='tel'
              {...register('emergencyContactPhone', { required: 'Emergency contact number is required' })}
              className='w-full border-b border-black/30 focus:outline-none p-2'
            />
          ...
          <div className='w-full h-auto flex flex-col justify-center items-start gap-2 my-2' >
              <h1 className='font-bold font-montserrat'>3. COVID-19 Acknowledgment</h1>
              <p>I understand that Spark STEM Academy follows recommended health guidelines, but there remains a risk of exposure to COVID-19 and other contagious illnesses. I agree not to hold Spark STEM Academy or its representatives liable in the event of exposure or illness.
              </p>
          </div>

          {/* Media Release */}
          <div className='w-full h-auto flex flex-col justify-start items-start gap-3 mt-4'>
            <h1 className='font-montserrat font-bold '>4. Media Release (Optional – Please check one)</h1>
            <div className='flex items-start gap-2'>
              ...
              />
              <label>I <span className='font-bold'>DO</span> give permission for Spark STEM Academy to use photographs/videos of my child for educational or promotional purposes.</label>
            </div>
            <div className='flex gap-2'>
              <input
                ...
                {...register('mediaRelease')}
              />
              <label>I <span className='font-bold'>DO NOT</span> give permission</label>
            </div>
          </div>
          ...
          <div className='w-full mt-4'>
            ...
            <p>By signing below, I acknowledge that I have read and understand this waiver, and agree to all terms outlined.</p>

            <label className='mt-2'>Date:</label>
            <p className='w-full border-b border-black/30 focus:outline-none p-2'>{new Date().toLocaleDateString()}</p>
      ...
      <motion.img ref={vect3Ref} style={{ x: vect3X }} src={vect3} alt="" className='hidden lg:block absolute w-1/4 left-4 top-[30%] opacity-90' />
      <motion.img ref={vect4Ref} style={{ x: vect4X }} src={vect4} alt="" className='hidden lg:block absolute w-1/4 right-4 top-[50%] opacity-90' />
    </div>
  );
};
